...
function Navigation(props) {
    return(
        <nav>
            ...
            <div className = {classes.nav_profile_name}>{props.state.myName.name}</div>
            <div className = {classes.nav_links}>
                <div  className={classes.item}><NavLink to = '/Profile' activeClassName={classes.active}>Profile</NavLink><span ></span></div>
                <div className={classes.item}><NavLink to = '/Messages' activeClassName={classes.active}>Messages</NavLink><span className = {classes.span_active}>{props.state.myName.countMessages}</span></div>
